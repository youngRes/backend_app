...
var $gamePlayer       = null;
var $testEvent        = null;  
var $loadMap          = null;                               //New
var $chapterPass      = null;                               //New
var $ajaxData         = null;
var $playerName       = null;
var $playerSex        = null;
var $userName         = null;                               //New: The username will be stored here
var $startX           = null;
var $startY           = null;
...
DataManager._databaseFiles = [
    ...
    { name: '$dataMapInfos',     src: 'MapInfos.json'     },    //New
    { name: '$dataChapterInfos', src: 'ChaptersInfo.json' },    //New
    { name: '$config',           src: 'config.json'       }     //New
];
...
DataManager.setupNewGame = function() {
    ...
    $gamePlayer.reserveTransfer($loadMap,
        $startX, $startY);
    Graphics.frameCount = 0;
};

DataManager.setupNewGameOld = function() {
    this.createGameObjects();
    this.selectSavefileForNewGame();
    $gamePlayer = new Game_Player();
    $gameParty.setupStartingMembers();
...
////////////////////// New ////////////////////////////
///////////////////////////////////////////////////////
DataManager.loadMapInfos = function() {
    var info = $dataChapterInfos
    return info;
};
...
////////////////////// New ////////////////////////////
///////////////////////////////////////////////////////
DataManager.loadAllMapfileImages = function() {
    var globalInfo = this.loadChapterInfo();
    if (globalInfo) {
        for (var i = 1; i < globalInfo.length; i++) {
            if (this.isThisGameFile(i)) {
                var info = globalInfo[i];
...
DataManager.loadChapterInfo = function(MapId) {
    var globalInfo = this.loadMapInfos();
    return globalInfo[MapId]
    //return (globalInfo && globalInfo[MapId]) ? globalInfo[MapId] : null;
};
...
Object.defineProperties(TextManager, {
    ...
    loadChapter     : TextManager.getter('command', 26),
    loginUser       : TextManager.getter('command', 27),
    ...
    loadChap        : TextManager.getter('message', 'loadChap'),
